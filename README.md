...
After the clean up, while printing the result, each `countMap` for the month will be consolidated using the refined `userMap` to do lookup, indirect referral is replaced by direct referral. 
